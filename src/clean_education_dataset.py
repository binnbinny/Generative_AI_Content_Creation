...
# Input file
input_path = project_root / "data" / "raw" / "education_dataset.csv"

# Output file
output_path = project_root / "data" / "processed" / "education_dataset_clean.csv"

# Load dataset
df = pd.read_csv(input_path)

print("===== EDUCATION DATA CLEANING =====")
print("Original rows:", len(df))

# Remove rows with missing prompt or content
